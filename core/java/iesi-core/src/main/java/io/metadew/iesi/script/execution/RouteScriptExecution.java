...
public class RouteScriptExecution extends ScriptExecution {
    ...
    public RouteScriptExecution(ScriptVersion scriptVersion, String environment, ExecutionControl executionControl,
                                ExecutionMetrics executionMetrics, Long processId, boolean exitOnCompletion,
                                ScriptExecution parentScriptExecution, Map<String, String> parameters,
                                Map<String, String> impersonations, ActionSelectOperation actionSelectOperation,
                                RootingStrategy rootingStrategy) {
        super(scriptVersion, environment, executionControl, executionMetrics, processId, exitOnCompletion,
                parentScriptExecution, parameters, impersonations, actionSelectOperation, rootingStrategy);
    }

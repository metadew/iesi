...
public class FrameworkObjectConfiguration {
	...
	public static String getFrameworkObjectType(Object object) {
		...
		else if (object.getClass().getSimpleName().equalsIgnoreCase("ScriptTypeParameter")) type = "scriptTypeParameter";
		else if (object.getClass().getSimpleName().equalsIgnoreCase("Connection")) type = "connection";
		else if (object.getClass().getSimpleName().equalsIgnoreCase("ConnectionParameter")) type = "connectionParameter";
		else if (object.getClass().getSimpleName().equalsIgnoreCase("ConnectionType")) type = "connectionType";
		else if (object.getClass().getSimpleName().equalsIgnoreCase("ConnectionTypeParameter")) type = "connectionTypeParameter";
		...
		else if (object.getClass().getSimpleName().equalsIgnoreCase("EnvironmentParameter")) type = "environmentParameter";
		...
		else if (object.getClass().getSimpleName().equalsIgnoreCase("ActionTypeParameter")) type = "actionTypeParameter";
		else if (object.getClass().getSimpleName().equalsIgnoreCase("Subroutine")) type = "subroutine";
		else if (object.getClass().getSimpleName().equalsIgnoreCase("SubroutineParameter")) type = "subroutineParameter";
		else if (object.getClass().getSimpleName().equalsIgnoreCase("SubroutineType")) type = "subroutineType";
		else if (object.getClass().getSimpleName().equalsIgnoreCase("SubroutineTypeParameter")) type = "subroutineTypeParameter";
		else type = "unknown";
		return type;
	}

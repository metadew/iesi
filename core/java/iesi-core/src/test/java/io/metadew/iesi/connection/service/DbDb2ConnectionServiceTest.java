...
import io.metadew.iesi.connection.database.db2.Db2Database;
import io.metadew.iesi.connection.database.db2.Db2DatabaseConnection;
...
@ActiveProfiles("test")
class DbDb2ConnectionServiceTest {
    ...
    void getDatabaseTest() {
        ...
        assertEquals(db2Database, databaseHandler.getDatabase(connection));
    }

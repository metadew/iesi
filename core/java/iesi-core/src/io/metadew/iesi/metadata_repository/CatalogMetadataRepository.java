...
public class CatalogMetadataRepository extends MetadataRepository {
    ...
    public CatalogMetadataRepository(String frameworkCode, String name, String scope, String instanceName, Repository repository, String repositoryObjectsPath, String repositoryTablesPath) {

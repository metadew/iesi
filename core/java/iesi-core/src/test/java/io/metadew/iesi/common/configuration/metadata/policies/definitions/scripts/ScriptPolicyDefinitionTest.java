...
public class ScriptPolicyDefinitionTest {
    ...
    @Test
    void scriptAlignsWithMultipleDefinitionDefinitionAndOneLabelPolicy() {
        ScriptLabelPolicy scriptLabelPolicy1 = new ScriptLabelPolicy("mylabel");
        ScriptLabelPolicy scriptLabelPolicy2 = new ScriptLabelPolicy("mylabel2");

        ScriptPolicyDefinition scriptPolicyDefinition = new ScriptPolicyDefinition(Stream.of(scriptLabelPolicy1).collect(Collectors.toList()));
        ...
        List<ScriptPolicyDefinition> scriptPolicyDefinitions = Stream.of(scriptPolicyDefinition, scriptPolicyDefinition2).collect(Collectors.toList());
        ...
        assertThatCode(() -> {
            scriptPolicyDefinitions.forEach(item -> {
                item.verify(script);
            });

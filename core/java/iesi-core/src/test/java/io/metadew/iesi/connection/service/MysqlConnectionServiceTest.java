...
@ActiveProfiles("test")
class MysqlConnectionServiceTest {
    ...
    void getDatabaseTest() {
        ...
        MysqlDatabase mysqlDatabase = new MysqlDatabase(
                new MysqlDatabaseConnection("host", 1, "database", "user", "password", ""));
        assertEquals(mysqlDatabase, databaseHandler.getDatabase(connection));
    }
    ...
    void getDatabaseConnectionUrlTest() {
        ...
        Assertions.assertEquals(mysqlDatabase, databaseHandler.getDatabase(connection));
    }
    ...
    void getDatabaseWithEncryptedPasswordTest() {
        Connection connection = new Connection(new ConnectionKey("test", "tst"),
                ...
                Stream.of(new ConnectionParameter(new ConnectionParameterKey(new ConnectionKey("test", "tst"), "host"), "host"),
                        ...
                        .collect(Collectors.toList()));
        MysqlDatabase mysqlDatabase = new MysqlDatabase(
                new MysqlDatabaseConnection("host", 1, "database", "user", "encrypted_password", ""));
        assertEquals(mysqlDatabase, databaseHandler.getDatabase(connection));
    }

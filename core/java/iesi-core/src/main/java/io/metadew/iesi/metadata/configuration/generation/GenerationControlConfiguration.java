...
//        String sql = "";
//
//        sql += "INSERT INTO " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationControls");
//        sql += " (GEN_ID, GEN_CTL_ID, GEN_CTL_NM, GEN_CTL_TYP_NM, GEN_CTL_DSC) ";
//        sql += "VALUES ";
//        sql += "(";
//        sql += "(" + SQLTools.GetLookupIdStatement(MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("Generations"), "GEN_ID", "GEN_NM", generationName) + ")";
//        sql += ",";
//        sql += "(" + SQLTools.GetNextIdStatement(MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationControls"), "GEN_CTL_ID") + ")";
//        sql += ",";
...
//                + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationControls") + " where GEN_CTL_ID = " + generationControlId;
//        crsGenerationControl = MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().executeQuery(queryGenerationControl, "reader");
...
//                String queryGenerationControlParameters = "select GEN_CTL_ID, GEN_CTL_PAR_NM from " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationControlParameters")
//                        + " where GEN_CTL_ID = " + generationControlId;
//                crsGenerationControlParameters = MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().executeQuery(queryGenerationControlParameters, "reader");
...
//                String queryGenerationControlRules = "select GEN_CTL_RULE_ID, GEN_CTL_RULE_NM from " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationControlRules")
//                        + " where GEN_CTL_ID = " + generationControlId;
//                crsGenerationControlRules = MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().executeQuery(queryGenerationControlRules, "reader");

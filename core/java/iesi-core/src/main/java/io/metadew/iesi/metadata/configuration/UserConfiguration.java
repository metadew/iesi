...
public class UserConfiguration {
    ...
    // Delete
    public String getDeleteStatement() throws Exception {
    ...
    // Delete
    public String getDeleteStatement(User user) throws Exception {
        return "DELETE FROM " + MetadataRepositoryConfiguration.getInstance().getControlMetadataRepository().getTableNameByLabel("Users") +
                " WHERE USER_NM = " + SQLTools.GetStringForSQL(user.getName()) + ";";
    }


    public List<String> getInsertStatement(User user) throws Exception {
    ...
    public String getPasswordStatement() throws Exception {
        String sql = "";
    ...
    public String getActiveUpdateStatement(String userName, String status) throws Exception {
    ...
    public String getBlockedUpdateStatement(String userName, String status) throws Exception {
        return "UPDATE " + MetadataRepositoryConfiguration.getInstance().getControlMetadataRepository().getTableNameByLabel("Users") +
                " SET USER_BLOCK_FL=" + SQLTools.GetStringForSQL(status.toUpperCase()) +
                " WHERE USER_NM =" + SQLTools.GetStringForSQL(userName) + ";";
    }

    public String resetIndividualLoginFails(String userName) throws Exception {
        return "UPDATE " + MetadataRepositoryConfiguration.getInstance().getControlMetadataRepository().getTableNameByLabel("Users") +

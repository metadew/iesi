...
GO
CREATE TABLE Table2 ( Field1 int, Field2 nvarchar(max), Field3  nvarchar(max), Field4  nvarchar(max), Field5  nvarchar(max), Field6  nvarchar(max), Field7  nvarchar(max), Field8  nvarchar(max), Field9  nvarchar(max), Field10  nvarchar(max) );
GO

...
//import io.metadew.iesi.metadata.configuration.MetadataObjectConfiguration;
...
//
//public abstract class MetadataRepositoryConfiguration2 {
//
...
//
//	public MetadataRepositoryConfiguration(FrameworkConfiguration frameworkConfiguration, FrameworkControl frameworkControl, DatabaseConnection databaseConnection) {
//		this.frameworkConfiguration = frameworkConfiguration;
//		this.frameworkControl = frameworkControl;
//		this.frameworkCrypto = new FrameworkCrypto();
//		this.databaseConnection = databaseConnection;
//		this.metadataTableConfiguration = new MetadataTableConfiguration(this.frameworkConfiguration,
//				this.frameworkControl.getProperties(), this.frameworkConfiguration.getSettingConfiguration(),
...
//	}
//
//	public MetadataRepositoryConfigurationBack(FrameworkConfiguration frameworkConfiguration,
...
//	// Clone
//	@Override
//	public MetadataRepositoryConfigurationBack clone() {
//		try {
//			return (MetadataRepositoryConfigurationBack) super.clone();
//		} catch (CloneNotSupportedException e) {
//			return new MetadataRepositoryConfigurationBack(this.getFrameworkConfiguration(), this.getConfigTools(),
//					this.getConfigFile(), this.getLogonType());
//		}
//	}
//
//	public abstract MetadataRepositoryConfigurationBack fromConfigFile(ConfigFile configFile, String LogonType);
//
//	// Methods

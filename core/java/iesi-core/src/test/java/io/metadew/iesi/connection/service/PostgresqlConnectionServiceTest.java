...
class PostgresqlConnectionServiceTest {
    ...
    void getDatabaseTest() {
        ...
        assertEquals(postgresqlDatabase, databaseHandler.getDatabase(connection));
    }
    ...
    void getDatabaseConnectionUrlTest() {
        ...
        Assertions.assertEquals(postgresqlDatabase, databaseHandler.getDatabase(connection));
    }

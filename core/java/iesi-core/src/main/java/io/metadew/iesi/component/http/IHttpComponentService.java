...
public interface IHttpComponentService {
    ...
    HttpComponent getAndTrace(String httpComponentReferenceName, ActionExecution actionExecution, String actionParameterName, String componentVersionParameterName);

...
class DateFormatTest {
    ...
    void generateOutputParseError() {
        DateFormat dateFormatddMMyyyy = new DateFormat();
        assertThrows(Exception.class, () -> dateFormatddMMyyyy.generateOutput("01052000 11:11:11, \"xxyyzzzz\""));
    }

    @Test
    void generateOutputInputError() {
        DateFormat dateFormatddMMyyyy = new DateFormat();
        assertThrows(Exception.class, () -> dateFormatddMMyyyy.generateOutput("01052000, \"xxyyzzzz\""));
    }
}

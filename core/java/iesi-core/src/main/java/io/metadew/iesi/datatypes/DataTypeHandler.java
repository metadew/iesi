...
public class DataTypeHandler {
    ...
    */
    ...
    public DataType resolve(DatabaseDatasetImplementation databaseDatasetImplementation, String key, JsonNode jsonNode, ExecutionRuntime executionRuntime) {
        if (jsonNode.getNodeType().equals(JsonNodeType.ARRAY)) {
            return ArrayService.getInstance().resolve(databaseDatasetImplementation, key, (ArrayNode) jsonNode, executionRuntime);
        ...
        if (jsonNode.getNodeType().equals(JsonNodeType.OBJECT)) {
            return DatabaseDatasetImplementationService.getInstance().resolve(databaseDatasetImplementation, key, (ObjectNode) jsonNode, executionRuntime);
        } else {

...
public class ExecutionRuntime {
    ...
    private String lookupConnectionInstruction(ExecutionControl executionControl, String input) {
        ...
        return connectionParameterConfiguration.getConnectionParameterValue(connectionName, executionControl.getEnvName(),
    ...
    private String lookupDatasetInstruction(ExecutionControl executionControl, String input) {
        ...
        return datasetOperation.getDataItem(datasetItem).orElse(input);
    }
    ...
    // Dataset Management
    public void setDataset(String referenceName, String datasetType, String datasetName, String datasetLabels) {
        DatasetOperation datasetOperation = new DatasetOperation(this.getFrameworkExecution(), this.getExecutionControl(), datasetType, datasetName, datasetLabels);

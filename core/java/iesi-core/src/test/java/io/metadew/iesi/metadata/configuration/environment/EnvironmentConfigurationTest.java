...
class EnvironmentConfigurationTest {
    ...
    void environmentGetTest() {
        ...
        Optional<Environment> fetchedEnvironment = EnvironmentConfiguration.getInstance().get(environment1.getMetadataKey());
        assertTrue(fetchedEnvironment.isPresent());
        assertEquals(environment1.getDescription(), fetchedEnvironment.get().getDescription());
        assertEquals(environment1.getMetadataKey(), fetchedEnvironment.get().getMetadataKey());
        assertEquals(environment1.getName(), fetchedEnvironment.get().getName());
        assertEquals(environment1.getParameters(), fetchedEnvironment.get().getParameters());
    }

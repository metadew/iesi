...
//        ConfigFile cfg = new ConfigFile(FrameworkConfiguration.getInstance().getMandatoryFrameworkFolder("modules.sqlinsert.run").getAbsolutePath() + File.separator + "engine.config");

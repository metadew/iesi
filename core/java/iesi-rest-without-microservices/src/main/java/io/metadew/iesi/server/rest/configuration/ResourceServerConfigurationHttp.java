...
public class ResourceServerConfigurationHttp extends ResourceServerConfigurerAdapter {

	private final TokenStore tokenStore;
	private final SecurityPropertiesClient securityProperties;

	public ResourceServerConfigurationHttp(TokenStore tokenStore, SecurityPropertiesClient securityProperties) {
		super();

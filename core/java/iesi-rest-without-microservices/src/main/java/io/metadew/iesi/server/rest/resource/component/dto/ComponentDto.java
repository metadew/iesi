...
public class ComponentDto extends Dto {
    ...
    public Component convertToEntity() {
        return new Component(new ComponentKey(IdentifierTools.getComponentIdentifier(name), version.getNumber()),
                type, name, description, version.convertToEntity(IdentifierTools.getComponentIdentifier(name)),
                parameters.stream()

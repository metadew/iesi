...
public class GetData {
    ...
    public GetData(FrameworkConfiguration frameworkConfiguration) {
        ...
        ConfigFile cfg = new ConfigFile(this.getFrameworkConfiguration().getFolderConfiguration().getFolderAbsolutePath("modules.sqlinsert.run.tmp")
                + File.separator + "data.config");
    ...
    public void doExec() {
        try {
            ...
            System.out.println("SQLServer JDBC Driver Not Available");
            e.printStackTrace();
            return;
        }

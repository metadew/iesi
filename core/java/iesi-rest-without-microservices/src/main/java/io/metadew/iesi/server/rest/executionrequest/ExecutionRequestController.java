...
public class ExecutionRequestController {
    ...
    private List<ExecutionRequestFilter> extractScriptFilterOptions(String name, String version, String environment, String labelKeyCombination, String runId, String runStatus, String requester) {
        ...
        if (requester != null) {
            executionRequestFilters.add(new ExecutionRequestFilter(ExecutionRequestFilterOption.REQUESTER, requester, true));
        }

...
public class BigqueryScriptresultDeleteCommand implements Runnable {
    ...
    public void run() {
        ...
        BigqueryConnection.getInstance().deleteTable(whichProject, datasetName, new ScriptResultConfiguration());
    }
}

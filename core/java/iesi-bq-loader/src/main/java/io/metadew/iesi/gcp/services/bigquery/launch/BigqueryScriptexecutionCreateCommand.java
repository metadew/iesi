...
public class BigqueryScriptexecutionCreateCommand implements Runnable {
    ...
    public void run() {
        ...
        BigqueryConnection.getInstance().createTable(whichProject, datasetName, new ScriptExecutionConfiguration());
    }
}

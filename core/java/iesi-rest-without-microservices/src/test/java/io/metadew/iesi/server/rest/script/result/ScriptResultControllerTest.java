...
class ScriptResultControllerTest {
    ...
    void getAllNoResultTest() throws Exception {
        ...
        mvc.perform(get("/script-results")
    ...
    void getAllScript2ResultsTest() throws Exception {
        ...
        mvc.perform(get("/script-results")
                ...
                .andExpect(jsonPath("$._embedded[0]._links.self.href",
                        is("http://localhost/script-results/" + scriptResult1.getMetadataKey().getRunId() + "/" + scriptResult1.getMetadataKey().getProcessId())))
                ...
                .andExpect(jsonPath("$._embedded[1]._links.self.href",
                        is("http://localhost/script-results/" + scriptResult2.getMetadataKey().getRunId() + "/" + scriptResult2.getMetadataKey().getProcessId())));
    }
    ...
    void getByRunIdNoResultTest() throws Exception {
        ...
        // Request
        mvc.perform(get("/script-results/notTheSameId")
                .contentType(MediaType.APPLICATION_JSON)
        ).andExpect(status().isOk())
                .andExpect(jsonPath("$", anEmptyMap()));
    }
    ...
    void getByRunId2Results() throws Exception {
        ...
        // Request
        mvc.perform(get("/script-results/sameId")
                .contentType(MediaType.APPLICATION_JSON)
        ).andExpect(status().isOk())
                .andExpect(jsonPath("$._embedded", hasSize(2)))
                ...
                .andExpect(jsonPath("$._embedded[0]._links.self.href", is("http://localhost/script-results/" + scriptResult1.getMetadataKey().getRunId() + "/" + scriptResult1.getMetadataKey().getProcessId())))
                .andExpect(jsonPath("$._embedded", hasSize(2)))
                ...
                .andExpect(jsonPath("$._embedded[1]._links.self.href", is("http://localhost/script-results/" + scriptResult2.getMetadataKey().getRunId() + "/" + scriptResult2.getMetadataKey().getProcessId())));
    }
    ...
    void getByRunIdAndProcessIdSuccessfulTest() throws Exception {
        ...
        // Request
        mvc.perform(get("/script-results/sameId/1")
                .contentType(MediaType.APPLICATION_JSON)
        ).andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$._links.self.href", is("http://localhost/script-results/" + scriptResult.getMetadataKey().getRunId() + "/" + scriptResult.getMetadataKey().getProcessId())));
    }
    ...
    void getByRunIdAndProcessIdNoResultTest() throws Exception {
        ...
        mvc.perform(get("/script-results/Id/1").contentType(MediaType.APPLICATION_JSON))

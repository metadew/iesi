...
//        //Get ConfigFile
//        ConfigFile cfg = new ConfigFile(FrameworkConfiguration.getInstance().getMandatoryFrameworkFolder("modules.sqlinsert.run.tmp").getAbsolutePath() + File.separator + "info.config");
...
//                    of.PrintToFile(this.getResultSet(rs), FrameworkConfiguration.getInstance().getMandatoryFrameworkFolder("modules.sqlinsert.run.tmp").getAbsolutePath() + File.separator + "info.txt");
//                    rs.close();

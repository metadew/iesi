...
//import io.metadew.iesi.metadata.execution.MetadataRepositoryConfiguration;
...
//                + MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().getTableNameByLabel("Features");
//        CachedRowSet crsFeature = MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().executeQuery(queryFeature, "reader");
//
//        try {
...
//                + MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().getTableNameByLabel("Features") + " where FEATURE_NM = '"
//                + featureName + "'";
//        CachedRowSet crsFeature = MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().executeQuery(queryFeature, "reader");
//        try {
...
//                    + MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().getTableNameByLabel("FeatureVersions") + " where FEATURE_ID = "
//                    + SQLTools.GetStringForSQL(crsFeature.getString("FEATURE_ID"));
//            CachedRowSet crsFeatureVersions = MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().executeQuery(queryFeatureVersions, "reader");
...
//        MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().executeBatch(deleteQuery);
//    }
//
...
//        MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().executeBatch(insertStatement);
//    }
//
...
//            queries.add("INSERT INTO " + MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().getTableNameByLabel("Features") +
...
//        List<String> queries = new ArrayList<>();
//        // delete parameters
//        queries.add("DELETE FROM " + MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().getTableNameByLabel("FeatureParameters") +
...
//        // delete version
//
//        queries.add("DELETE FROM " + MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().getTableNameByLabel("FeatureVersions") +
//                " WHERE FEATURE_ID = " + SQLTools.GetStringForSQL(feature.getId()) + " AND FEATURE_VRS_NB = " + SQLTools.GetStringForSQL(feature.getVersion().getNumber()) + ";");
//
//        // delete scenarios
//        for (Scenario scenario : feature.getScenarios()) {
//            queries.add("DELETE FROM " + MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().getTableNameByLabel("Scenarios") +
//                    " WHERE SCENARIO_ID = " + SQLTools.GetStringForSQL(scenario.getId()) + ";");
//            queries.add("DELETE FROM " + MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().getTableNameByLabel("ScenarioParameters") +
//                    " WHERE SCENARIO_ID = " + SQLTools.GetStringForSQL(scenario.getId()) + ";");
//        }
//
//        // delete feature info if last version
//        String countQuery = "SELECT COUNT(DISTINCT FEATURE_VRS_NB ) AS total_versions FROM "
//                + MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().getTableNameByLabel("FeatureVersions")
...
//        CachedRowSet crs = MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().executeQuery(countQuery, "reader");
//
//        try {
//            if (crs.next() && Integer.parseInt(crs.getString("total_versions")) == 0) {
//                queries.add("DELETE FROM " + MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().getTableNameByLabel("Features") +
...
//                + MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().getTableNameByLabel("Features") + " where FEATURE_NM = '"
//                + featureName + "'";
//        crsFeature = MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().executeQuery(queryFeature, "reader");
//        try {
//            while (crsFeature.next()) {
...
//
//        if (this.exists()) {
//            sql += "DELETE FROM " + MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().getTableNameByLabel("ScenarioParameters");
//            sql += " WHERE FEATURE_ID = '" + this.getFeature().getId() + "'";
//            sql += " AND FEATURE_VRS_NB = " + this.getFeature().getVersion().getNumber();
//            sql += ";";
//            sql += "\n";
//            sql += "DELETE FROM " + MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().getTableNameByLabel("Scenarios");
//            sql += " WHERE FEATURE_ID = '" + this.getFeature().getId() + "'";
//            sql += " AND FEATURE_VRS_NB = " + this.getFeature().getVersion().getNumber();
//            sql += ";";
//            sql += "\n";
//            sql += "DELETE FROM " + MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().getTableNameByLabel("FeatureVersions");
//            sql += " WHERE FEATURE_ID = '" + this.getFeature().getId() + "'";
//            sql += " AND FEATURE_VRS_NB = " + this.getFeature().getVersion().getNumber();
//            sql += ";";
//            sql += "\n";
...
//            sql += "INSERT INTO " + MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().getTableNameByLabel("Features");
...
//                + MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().getTableNameByLabel("FeatureVersions") + " a inner join "
//                + MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().getTableNameByLabel("Features")
//                + " b on a.feature_id = b.feature_id where b.feature_nm = '" + featureName + "'";
//        CachedRowSet crsFeatureVersion = MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().executeQuery(queryFeatureVersion, "reader");
//        try {
...
//                    + MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().getTableNameByLabel("Scenarios")
//                    + " where FEATURE_ID = " + SQLTools.GetStringForSQL(featureId) + " and FEATURE_VRS_NB = " + versionNumber
//                    + " order by SCENARIO_NB asc ";
//            CachedRowSet crsScenarios = MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().executeQuery(queryScenarios, "reader");
//
...
//                    + MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository().getTableNameByLabel("FeatureParameters")
//                    + " where FEATURE_ID = " + SQLTools.GetStringForSQL(featureId) + " and FEATURE_VRS_NB = " + versionNumber;
//            CachedRowSet crsFeatureParameters = MetadataRepositoryConfiguration.getInstance().getCatalogMetadataRepository()

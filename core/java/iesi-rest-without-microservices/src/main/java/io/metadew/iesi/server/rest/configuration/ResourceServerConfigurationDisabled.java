...
public class ResourceServerConfigurationDisabled extends ResourceServerConfigurerAdapter {

	@Autowired
	private TokenStore tokenStore;

//	public ResourceServerConfigurationDisabled(TokenStore tokenStore) {
//		super();

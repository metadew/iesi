...
//        ConfigFile cfg = new ConfigFile(FrameworkConfiguration.getInstance().getMandatoryFrameworkFolder("modules.sqlinsert.run.tmp").getAbsolutePath() + File.separator + "buffer.config");
...
//        if (connection != null) {
//            try {
//                io.metadew.iesi.sqlinsert.sqlite.getSQL sqlTools = new io.metadew.iesi.sqlinsert.sqlite.getSQL();
//

...
public class MssqlDatabaseConnectionServiceTest {
    ...
    void refactorOneLimitAndOffset() {
        ...
        assertThat(MssqlDatabaseConnectionService.getInstance().refactorLimitAndOffset(query))
                .isEqualTo("SELECT script.SCRIPT_ID, script.SCRIPT_DSC  OFFSET 77 ROWS FETCH NEXT 10 ROWS ONLY ");
        assertThat(MssqlDatabaseConnectionService.getInstance().refactorLimitAndOffset(query2))

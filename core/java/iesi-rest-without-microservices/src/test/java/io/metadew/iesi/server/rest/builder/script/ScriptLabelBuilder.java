...
//        return new ScriptLabel(new ScriptLabelKey(UUID.randomUUID().toString()), new ScriptVersionKey(new ScriptKey(scriptId), scriptVersionNumber, "NA") , name, getValue().orElse("dummy"));
//    }
//

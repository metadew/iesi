...
//        this.cfg = new ConfigFile(FrameworkConfiguration.getInstance().getMandatoryFrameworkFolder("modules.sqlinsert.run.tmp").getAbsolutePath() + File.separator + "exec.config");
//    }
//
//    public void doExec() {
//        try {

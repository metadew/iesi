...
public class MetadataFileStoreRepositoryImpl {
	...
	public void createStructure() {		
		// Verify path
		String path = this.getFrameworkExecution().getMetadataControl().getDesignRepositoryConfiguration().getFileStoreConnection().getPath();
	...
	public void dropStructure() {	
		FolderTools.deleteFolder(this.getFrameworkExecution().getMetadataControl().getDesignRepositoryConfiguration().getFileStoreConnection().getPath(), false);
	}

...
//
//        if (this.exists()) {
//            sql += "DELETE FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationOutputParameters");
//            sql += " WHERE GEN_OUT_ID in (";
//            sql += "select GEN_OUT_ID FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationOutputs");
//            sql += " WHERE GEN_ID = (";
//            sql += "select GEN_ID FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("Generations");
//            sql += " WHERE GEN_NM = " + SQLTools.GetStringForSQL(this.getGeneration().getName());
//            sql += ")";
//            sql += ")";
//            sql += ";";
//            sql += "\n";
//            sql += "DELETE FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationOutputs");
//            sql += " WHERE GEN_ID = (";
//            sql += "select GEN_ID FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("Generations");
//            sql += " WHERE GEN_NM = " + SQLTools.GetStringForSQL(this.getGeneration().getName());
//            sql += ")";
//            sql += ";";
//            sql += "\n";
//            sql += "DELETE FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationControlRuleParameters");
//            sql += " WHERE GEN_CTL_RULE_ID in (";
//            sql += "select GEN_CTL_RULE_ID FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationControlRules");
//            sql += " WHERE GEN_CTL_ID in (";
//            sql += "select GEN_CTL_ID FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationControls");
//            sql += " WHERE GEN_ID in (";
//            sql += "select GEN_ID FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("Generations");
//            sql += " WHERE GEN_NM = " + SQLTools.GetStringForSQL(this.getGeneration().getName());
//            sql += ")";
...
//            sql += ";";
//            sql += "\n";
//            sql += "DELETE FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationControlRules");
//            sql += " WHERE GEN_CTL_RULE_ID in (";
//            sql += "select GEN_CTL_RULE_ID FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationControlRules");
//            sql += " WHERE GEN_CTL_ID in (";
//            sql += "select GEN_CTL_ID FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationControls");
...
//            sql += ";";
//            sql += "\n";
//            sql += "DELETE FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationControlParameters");
//            sql += " WHERE GEN_CTL_ID in (";
//            sql += "select GEN_CTL_ID FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationControls");
//            sql += " WHERE GEN_ID in (";
//            sql += "select GEN_ID FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("Generations");
...
//            sql += ";";
//            sql += "\n";
//            sql += "DELETE FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationControls");
//            sql += " WHERE GEN_ID in (";
//            sql += "select GEN_ID FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("Generations");
//            sql += " WHERE GEN_NM = " + SQLTools.GetStringForSQL(this.getGeneration().getName());
//            sql += ")";
//            sql += ";";
//            sql += "\n";
//            sql += "DELETE FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationRuleParameters");
//            sql += " WHERE GEN_RULE_ID in (";
//            sql += "select GEN_RULE_ID FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationRules");
//            sql += " WHERE GEN_ID in (";
//            sql += "select GEN_ID FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("Generations");
//            sql += " WHERE GEN_NM = " + SQLTools.GetStringForSQL(this.getGeneration().getName());
//            sql += ")";
...
//            sql += ";";
//            sql += "\n";
//            sql += "DELETE FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationRules");
//            sql += " WHERE GEN_ID in (";
//            sql += "select GEN_ID FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("Generations");
//            sql += " WHERE GEN_NM = " + SQLTools.GetStringForSQL(this.getGeneration().getName());
//            sql += ")";
//            sql += ";";
//            sql += "\n";
//            sql += "DELETE FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationParameters");
//            sql += " WHERE GEN_ID in (";
//            sql += "select GEN_ID FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("Generations");
//            sql += " WHERE GEN_NM = " + SQLTools.GetStringForSQL(this.getGeneration().getName());
//            sql += ")";
//            sql += ";";
//            sql += "\n";
//            sql += "DELETE FROM " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("Generations");
//            sql += " WHERE GEN_NM = " + SQLTools.GetStringForSQL(this.getGeneration().getName());
//            sql += ";";
//            sql += "\n";
//        }
//
//        sql += "INSERT INTO " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("Generations");
//        sql += " (GEN_ID, GEN_TYP_NM, GEN_NM, GEN_DSC) ";
//        sql += "VALUES ";
//        sql += "(";
//        sql += "(" + SQLTools.GetNextIdStatement(MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("Generations"), "GEN_ID") + ")";
//        sql += ",";
...
//        String queryGeneration = "select GEN_ID, GEN_TYP_NM, GEN_NM, GEN_DSC from " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("Generations") + " where GEN_NM = '" + generationName + "'";
//        crsGeneration = MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().executeQuery(queryGeneration, "reader");
...
//                String queryRules = "select GEN_ID, GEN_RULE_ID, GEN_RULE_NB from " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationRules")
//                        + " where GEN_ID = " + generation.getId() + " order by GEN_RULE_NB asc ";
//                CachedRowSet crsRules = null;
//                crsRules = MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().executeQuery(queryRules, "reader");
//                while (crsRules.next()) {
...
//                String queryOutputs = "select GEN_ID, GEN_OUT_ID from " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationOutputs")
//                        + " where GEN_ID = " + generation.getId() + " order by GEN_OUT_ID asc ";
//                CachedRowSet crsOutputs = null;
//                crsOutputs = MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().executeQuery(queryOutputs, "reader");
...
//                String queryControls = "select GEN_ID, GEN_CTL_ID from " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationControls")
//                        + " where GEN_ID = " + generation.getId() + " order by GEN_CTL_ID asc ";
//                CachedRowSet crsControls = null;
//                crsControls = MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().executeQuery(queryControls, "reader");
...
//                String queryGenerationParameters = "select GEN_ID, GEN_PAR_NM from " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationParameters")
//                        + " where GEN_ID = " + generation.getId();
//                crsGenerationParameters = MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().executeQuery(queryGenerationParameters, "reader");
...
////        String query = "select GEN_NM, GEN_DSC from " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("Generations")
////                + " order by GEN_NM ASC";

...
class DelimitedFileBeatElasticSearchConnectionTest {
    ...
    void toStringString() {
        ...
        assertThat(delimitedFileBeatElasticSearchConnection.toString("a")).isEqualTo("\"a\"");
    }
    ...
    void toStringObject() {
        ...
        assertThat(delimitedFileBeatElasticSearchConnection.toString(testObject)).isEqualTo("\"a\" \"b\" \"c\" \"d\"");
    }

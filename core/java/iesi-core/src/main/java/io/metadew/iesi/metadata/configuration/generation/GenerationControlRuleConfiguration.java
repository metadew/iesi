...
//        String sql = "";
//
//        sql += "INSERT INTO " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationControlRules");
//        sql += " (GEN_CTL_ID, GEN_CTL_RULE_ID, GEN_CTL_RULE_NB, GEN_CTL_RULE_TYP_NM, GEN_CTL_RULE_NM, GEN_CTL_RULE_DSC) ";
//        sql += "VALUES ";
//        sql += "(";
//        sql += "(" + SQLTools.GetLookupIdStatement(MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationControls"), "GEN_CTL_ID", "where GEN_CTL_NM = '" + generationControlName + "' and GEN_ID = (" + SQLTools.GetLookupIdStatement(MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("Generations"), "GEN_ID", "GEN_NM", generationName) + ")") + ")";
//        sql += ",";
//        sql += "(" + SQLTools.GetNextIdStatement(MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationControlRules"), "GEN_CTL_RULE_ID") + ")";
//        sql += ",";
...
//                + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationControlRules") + " where GEN_CTL_RULE_ID = " + generationControlRuleId;
//        crsGenerationControlRule = MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().executeQuery(queryGenerationControlRule, "reader");
...
//                String queryGenerationControlRuleParameters = "select GEN_CTL_RULE_ID, GEN_CTL_RULE_PAR_NM from " + MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().getTableNameByLabel("GenerationControlRuleParameters")
//                        + " where GEN_CTL_RULE_ID = " + generationControlRuleId;
//                crsGenerationControlRuleParameters = MetadataRepositoryConfiguration.getInstance().getDesignMetadataRepository().executeQuery(queryGenerationControlRuleParameters, "reader");
